...
class SettingsStore(context: Context) {
    ...
    var binderUnfreezeEnabled: Boolean
        get() = prefs.getBoolean(KEY_BINDER_UNFREEZE, true)
        set(value) = prefs.edit().putBoolean(KEY_BINDER_UNFREEZE, value).apply()
    ...
    private companion object {
        ...
        const val KEY_BINDER_UNFREEZE = "binder_unfreeze_enabled"
